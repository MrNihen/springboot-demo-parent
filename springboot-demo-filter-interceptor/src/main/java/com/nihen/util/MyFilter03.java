 ...
 */
@Order(3)
@WebFilter(filterName = "MyFilter03",urlPatterns = "/*", //目录下的所有资源进行过滤
...
public class MyFilter03 implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        System.out.println("过滤器333333333被调用了！" );
    }
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        System.out.println("我是过滤器3的执行方法，客户端向Servlet发送的请求被我拦截到了");
        ...
        System.out.println("我是过滤器3的执行方法，Servlet向客户端发送的响应被我拦截到了");
    }
    ...
    @Override
    public void destroy() {
        System.out.println("过滤器333333333333销毁了！臭弟弟再见！");
    }
}
